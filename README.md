...
__DEPRECATED__ Please use [CyVerse-Ansible.irods-cfg](https://galaxy.ansible.com/CyVerse-Ansible/irods-cfg/) to generate irods_environment.json file for server.
